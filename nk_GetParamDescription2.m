...
%                             preprocact{i} = sprintf('%s ]', preprocact{i});
	...
	case 'GridParam'
        if isfield(params.SVM,'GridParam')
           [~, ~, ~, vargout.GridParam ] = nk_GetScaleYAxisLabel(params.SVM);
        else
    ...
    case 'classifier'
        switch params.SVM.prog
            ...
            case {'LIBSVM'}
                ...
                switch classifier
                    case 0
                        vargout.classifier = 'C-SVC (L1-loss)';
                    case 1
                        switch params.SVM.LIBSVM.LIBSVMver
                            case {0,1,2}
                                vargout.classifier = 'nu-SVC';
                            case 3
                                vargout.classifier = 'C-SVC (L2-loss)';
                        end
                    case 2
                        switch params.SVM.LIBSVM.LIBSVMver
                            case {0,1,2}
                    ...
                    case 5
                        vargout.classifier = 'nu-SVR';
                                ...
                                vargout.classifier = [classifier '(' num2str(nuparam) ')'];
                    case 6
                        vargout.classifier = 'Support-Vector Domain Descriptor (L1-loss)';
                    case 7
                        vargout.classifier = 'Support-Vector Domain Descriptor (L2-loss)';
                    otherwise
