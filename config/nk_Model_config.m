...
if isfield(SVM,'prog')
    ...
    if isfield(SVM,'prog') && ~any(strcmp(SVM.prog,{'kNNMEX','GLMFIT','DECTRE','RNDFOR','MEXELM','ELASVM','ROBSVM', 'MLPERC', 'TFDEEP'}))
    ...
    % in these cases
    if any(strcmp(SVM.prog,{'IMRELF','kNNMEX','LIBLIN','ROBSVM','GLMFIT','MEXELM', 'DECTRE','RNDFOR', 'GLMNET','GRDBST','SEQOPT','WBLCOX', 'ELASVM', 'MLPERC', 'TFDEEP'}))
