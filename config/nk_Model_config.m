...
if isfield(SVM,'prog')
    ...
    if isfield(SVM,'prog') && ~any(strcmp(SVM.prog,{'kNNMEX','GLMFIT','DECTRE','RNDFOR','MEXELM','ELASVM','ROBSVM', 'MLPERC', 'TFDEEP','BAYLIN'}))
    ...
    % in these cases
    if any(strcmp(SVM.prog,{'IMRELF','kNNMEX','LIBLIN','ROBSVM','GLMFIT','MEXELM', 'DECTRE','RNDFOR', 'GLMNET','GRDBST','SEQOPT','WBLCOX', 'ELASVM', 'MLPERC', 'TFDEEP', 'BAYLIN'}))
...
if ~isfield(SVM,'Post'), SVM.Post.Detrend = false; end
    ...
    case 'classification'
        if EXPERT
            sftmenu = ['SVM --------------> LIBSVM|' ...
                       ...
                       'BAYES LINEAR -----> Python''s sklearn.linear_model.BayesianRidge with sigmoid fitting function|' ...  
                       ...
                       'GRADIENT BOOST----> Python''s sklearn.ensemble.GradientBoostingClassifier algorithm|' ...
                       'NEURAL -----------> Python''s sklearn.neural_network.MLPClassifier algorithm|' ...
                       'DEEP NN ----------> Python''s tensorflow.keras.Sequential algorithm|'];
           sftval   = [ 'LIBSVM'; ...
                        'LIBLIN'; ...
                        'ELASVM'; ...
                        'MEXELM'; ...
    ...
    case 'regression'
        if EXPERT
            sftmenu = [ 'SVM --------------> LIBSVM|' ...
                        ...
                        'BAYES LINEAR -----> Python''s sklearn.linear_model.ARDRegression|' ...  
                        ...
                        'NEURAL -----------> Python''s sklearn.neural_network.MLPRegressor algorithm|' ... 
                        'DEEP NN ----------> Python''s tensorflow.keras.Sequential algorithm|'];
            sftval = ['LIBSVM'; ...
                      'LIBLIN'; ...
                      'MikRVM'; ...
...
switch act
    ...
    case 2
        ...
        switch SVM.prog
            ...
            case {'GLMNET','GRDBST', 'MLPERC', 'TFDEEP'}
                if ~isfield(SVM,SVM.prog), SVM.(SVM.prog) = []; end
    ...
    case {5, 6}
        ...
        SVM.Post.Detrend = ~SVM.Post.Detrend;
